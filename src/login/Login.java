...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bg.add(userTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 250, 260, 30));
        ...
        bg.add(passTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 330, 260, 30));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/user.png"))); // NOI18N
        bg.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 80, -1, -1));

        iconUser.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/login.png"))); // NOI18N
        bg.add(iconUser, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 250, -1, -1));

        iconPass.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/candado.png"))); // NOI18N
        bg.add(iconPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 330, -1, -1));

        jSeparator5.setForeground(new java.awt.Color(0, 153, 255));
        jSeparator5.setPreferredSize(new java.awt.Dimension(200, 10));
        bg.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 360, -1, -1));

        jSeparator6.setForeground(new java.awt.Color(0, 153, 255));
        jSeparator6.setPreferredSize(new java.awt.Dimension(200, 10));
        bg.add(jSeparator6, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 280, -1, -1));
        ...
        bg.add(login, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 420, 140, 50));

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(bg, javax.swing.GroupLayout.PREFERRED_SIZE, 1378, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
